...
bl_info = {
    ...
    "version": (0, 1, 0),
    "blender": (2, 79, 0),
    "location": "User Preferences > Keymap > assign mesh.grow_sel_to_cursor",
    "category": "Mesh"
}
...
def register():
    bpy.utils.register_class(EDIT_OT_grow_sel_to_cursor)

def unregister():
    bpy.utils.unregister_class(EDIT_OT_grow_sel_to_cursor)
